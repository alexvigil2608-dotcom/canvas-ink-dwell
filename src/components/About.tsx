          ...
          <div className="grid md:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <div className="space-y-8">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Con más de 10 años de trayectoria, hemos completado más de 5000 proyectos 
            ...
            <div className="space-y-12">
              <div>
                ...
                <div className="space-y-6">
                  <div className="border-l-2 border-architectural pl-6">
                    <h5 className="text-lg font-medium mb-2">Planificación</h5>
                  ...
                  <div className="border-l-2 border-architectural pl-6">
                    <h5 className="text-lg font-medium mb-2">Calidad</h5>
              ...
              <div className="pt-8 border-t border-border">
                <div className="grid grid-cols-2 gap-8">
                  <div>
                    <h4 className="text-minimal text-muted-foreground mb-2">EXPERIENCIA</h4>
